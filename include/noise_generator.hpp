...
namespace crisp
{
    ...
    /// @param RandomNumberDistribution_t: takes a probability density functions and returns a pseudo-random number following that PDF
    ...
    class NoiseGenerator
    {
        public:
            ...
            /// @brief specify the minimal and maximal response of the noise generator
    ...
    struct GaussianNoise : public NoiseGenerator<std::normal_distribution<float>>
    {
        ...
        /// @brief construct gaussian noise
    ...
    struct SaltAndPepperNoise : public NoiseGenerator<SaltAndPepperDistribution>
    {
        ...
        /// @param salt_chance: the likelihood of a positive impulse being returned, may be 0
        /// @param pepper_chance: the likelihood of a negative impulse being returned, may be 0
        /// @param : the seed
