...
void main()
{
    ...
    min_v = min(min_v,to_value(_structuring_element[2][3]) * texture(_texture, _tex_coord + (vec2(1, 2) * step_size)));
    ...
    min_v = min(min_v,to_value(_structuring_element[3][2]) * texture(_texture, _tex_coord + (vec2(2, 1) * step_size)));
    min_v = min(min_v,to_value(_structuring_element[3][3]) * texture(_texture, _tex_coord + (vec2(2, 2) * step_size)));
