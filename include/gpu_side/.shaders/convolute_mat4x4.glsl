...
void main()
{
    ...
    kernel_val = _kernel[0][3];
    response += kernel_val * texture(_texture, _tex_coord + (vec2(-1, 2) * step_size));
    kernel_sum += kernel_val;
    ...
    kernel_val = _kernel[3][2];
    response += kernel_val * texture(_texture, _tex_coord + (vec2(2, 1) * step_size));
    kernel_sum += kernel_val;

    kernel_val = _kernel[3][3];
    response += kernel_val * texture(_texture, _tex_coord + (vec2(2, 2) * step_size));
    kernel_sum += kernel_val;
