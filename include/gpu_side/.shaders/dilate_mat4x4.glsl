...
void main()
{
    ...
    max_v = max(max_v,_structuring_element[0][3] * texture(_texture, _tex_coord + (vec2(-1, 2) * step_size)));
    ...
    max_v = max(max_v,_structuring_element[1][3] * texture(_texture, _tex_coord + (vec2(0, 2) * step_size)));
    ...
    max_v = max(max_v,_structuring_element[2][3] * texture(_texture, _tex_coord + (vec2(1, 2) * step_size)));
    ...
    max_v = max(max_v,_structuring_element[3][2] * texture(_texture, _tex_coord + (vec2(2, 1) * step_size)));
    max_v = max(max_v,_structuring_element[3][3] * texture(_texture, _tex_coord + (vec2(2, 2) * step_size)));
