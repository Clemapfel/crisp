...
int main()
{
    ...
    save_to_disk(histogram.to_image(), "/home/clem/Workspace/crisp/docs/noise/.resources/clean_hist.png");
    ...
    save_to_disk(histogram.to_image(), "/home/clem/Workspace/crisp/docs/noise/.resources/uniform_hist.png");
    ...
    histogram = Histogram<256>(image);
    save_to_disk(histogram.to_image(), "/home/clem/Workspace/crisp/docs/noise/.resources/gaussian_hist.png");
    ...
    histogram = Histogram<256>(image);
    save_to_disk(histogram.to_image(), "/home/clem/Workspace/crisp/docs/noise/.resources/gamma_hist.png");
    ...
    histogram = Histogram<256>(image);
    save_to_disk(histogram.to_image(), "/home/clem/Workspace/crisp/docs/noise/.resources/salt_and_pepper_hist.png");
}
